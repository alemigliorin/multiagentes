      ...
      {isEditing ? (
        <div className="flex w-full items-center gap-1">
          <input
            ...
            className="border-primary/15 placeholder:text-muted/50 flex h-9 w-full items-center text-ellipsis rounded-xl border bg-accent p-3 text-xs font-medium text-muted"
            autoFocus
          />
          <Button
            variant="ghost"
        ...
        <div className="flex w-full items-center gap-1">
          <motion.div
            className="border-primary/15 relative flex h-9 w-full cursor-pointer items-center justify-between rounded-xl border bg-accent p-3 uppercase"
